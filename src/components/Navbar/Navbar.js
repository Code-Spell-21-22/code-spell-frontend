        ...
        return (
            <Row className="container-fluid my-5">
                <Col className="col-3 justify-content-start d-flex">
                    <Button className="shadow w-75 bg-white justify-content-center align-items-center d-flex" style={{border: "none", height: "6vh"}} href="/">
                        <span style={{color: "#2C5AA2"}}>EXIT</span>
                    </Button>
                </Col>
                <Col className="col-6">
                    <Card className="shadow w-100" style={{backgroundColor: "#3f73c2", border: "none", height: "6vh"}}>
